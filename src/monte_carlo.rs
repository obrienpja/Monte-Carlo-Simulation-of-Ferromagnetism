...
impl MonteCarlo{
    pub fn run_monte_carlo_ferro(nitr:i32) -> SpinConfig{
    ...
    pub fn run_monte_carlo_antiferro(nitr:i32) -> SpinConfig{
        let mut test_spin_config:SpinConfig = SpinConfig::random_spin_config(10);
        let mut ferro_exchange: ExchangeMatrix = ExchangeMatrix::antiferromagnetic_exchange(10);
